...
# fourth chart shows rural population vs arable land
    ...
    # This csv file contains data about the total rural population for various
    #countries over many years
    # Make a bar chart showing the rural population of these countries
    #['United States', 'China', 'Japan', 'Germany', 'United Kingdom', 'India',
    #'France', 'Brazil', 'Italy', 'Canada'] in the year 2015.

    # HINT: you can use the clean_data() function. You'll need to specify the
    #path to the csv file, and which columns you want to keep. The chart 2 code
    #might help with understanding how to code this.
    graph_five = []
    ...
    # TODO: once the data is clean, make a list called graph_five and append the
    #plotly graph to this list.
    graph_five.append(
        go.Bar(
        x = df.country.tolist(),
